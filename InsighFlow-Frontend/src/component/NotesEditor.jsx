...
// // //   try {
// // //     await axios.post("/saveMarkdown", { markdown, userId, noteName });
...
// // //   };
// // //   useEffect(() => {
// // //     console.log(markdown); // This will now log the updated value after state changes
// // //   }, [markdown]);
...
// //   useEffect(() => {
// //     console.log(markdown); // This will log the updated value after state changes
// //   }, [markdown]);
...
// //       const userId = token.user.id;
// //       await axios.post(`${API_URL}/saveMarkdown`, {
// //         markdown,
...
//       setIsLoading(true);
//       const userId = token.user.id;
//       const response = await axios.post("/saveMarkdown", {
//         markdown,
//         userId,
//         noteName: noteName.trim(),
//         noteId: currentNoteId, // Pass the currentNoteId if updating existing note
//       });

//       console.log("Markdown saved successfully");
//       setShowSaveDialog(false);

//       // If it's a new note, set the returned noteId
...
//       setIsLoading(true);
//       const userId = token.user.id;
//       const response = await axios.get(`/getUserNotes/${userId}`);

//       // Expecting response with array of objects containing noteId and noteName
...
//     try {
//       setIsLoading(true);
//       const response = await axios.get(`/getNote/${noteId}`);
...
//         // Remove the deleted note from the userNotes state
//         setUserNotes(userNotes.filter((note) => note.noteId !== noteId));

//         // If the currently loaded note was deleted, clear the editor
...
//                   <div
//                     key={note.noteId}
//                     className="border rounded-lg p-4 hover:bg-gray-50 transition cursor-pointer flex flex-col"
//                   >
...
//                         </button>
//                         <button
//                           onClick={() => deleteNote(note.noteId, note.noteName)}
...
//                       <p className="font-medium truncate" title={note.noteName}>
//                         {note.noteName}
//                       </p>
//                       <p className="text-xs text-gray-500 mt-1">
//                         ID: {note.noteId.substring(0, 8)}...
//                       </p>
//                     </div>
//                   </div>
//                 ))}
